 ...
 *
 * O idioma sai do cookie, que o middleware já preencheu a partir de `?lang=`
 * quando o link trazia um. Um layout não recebe os parâmetros do endereço, e é
 * por isso que a decisão foi empurrada para lá.
 */
