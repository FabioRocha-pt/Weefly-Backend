          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2.5">
              <h1 className="text-xl font-bold text-adm-txt">
                {trip?.lead?.full_name ?? t("admin.awaitingFill")}
              </h1>
              {trip?.reference && (
